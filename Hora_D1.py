...
last_date_modified = last_modified_file_date(path=file_path)

log = r"\\192.168.10.21\saturno\24 - MIS\07 - TIM\02 - Hora a Hora\00 - Projeto Alteryx\Fluxo Hora a Hora_D-1.log.txt"
...
Mensagem = f"""⚠️ HORA HORA D-1 {datetimenow}\n 
